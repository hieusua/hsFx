 ...
 */
public class LeftSideButtonSkin extends Border
{
//	include "../../core/Version.as";
	 ...
	 *  @productversion Flex 3
	 */
	public function LeftSideButtonSkin()
	{
		super();
	}
	...
	override protected function updateDisplayList(w:Number, h:Number):void
	{
		...
		var cr:Object = { tl: cornerRadius, tr: 0, bl: cornerRadius, br: 0 };
		var cr2:Object = { tl: cornerRadius2, tr: 0, bl: cornerRadius, br: 0 };
		...
		switch (name)
		{
			case "upSkin":
			{
				...
				drawRoundRect(
					...
					verticalGradientMatrix(0, 2, w - 6, h - 2));
			
				// tab highlight
				drawRoundRect(
					1, 1, (w - 2) / 2, (h - 2), cr2,
					[ 0xFFFFFF, 0xFFFFFF ], highlightAlphas,
					verticalGradientMatrix(1, 1, (w - 2) / 2, (h - 2) ));
...
//						borderColor, fillAlphas[1]);
			...
			case "overSkin":
			{
				...
				drawRoundRect(
					...
					verticalGradientMatrix(0, 0, w - 6, h),
					GradientType.LINEAR, null, 
					{ x: 1, y: 1, w: w - 2, h: h - 2, r: cr2 });
