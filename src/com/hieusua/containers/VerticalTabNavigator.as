...
import com.hieusua.controls.VerticalTabBar;
 ...
 *  @productversion Flex 3
 */
public class VerticalTabNavigator extends ViewStack implements IFocusManagerComponent
{
//    include "../core/Version.as";
     ...
     *  @private
     */
    private static const MIN_TAB_HEIGHT:Number = 30;
    ...
    override protected function get contentX():Number
    {
        ...
        return tabBarWidth + paddingLeft - 1;
    }
    ...
    override protected function get contentY():Number
    {
        ...
        return paddingTop;//tabBarHeight + paddingTop;
    }
    ...
    private function get tabBarWidth():Number
    {
        ...
        return tabWidth - borderMetrics.left;
    }
    ...
    override protected function measure():void
    {
        ...
        var minTabBarHeight:Number =
            numChildren * Math.max(tabHeight, MIN_TAB_HEIGHT);
